...
namespace Diem_Danh_SV
{
    ...
    private void cbo_ngay_SelectedIndexChanged(object sender, EventArgs e) 
        { 
            cbo_ngay.SelectedIndexChanged += new EventHandler(cbo_ngay_SelectedIndexChanged);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection(constr))
            {
                ...
                // Tạo câu lệnh SQL để tải lại dữ liệu
                string loadQuery = "SELECT DISTINCT MaSV, VangCoPhep, VangKhongPhep FROM DIEMDANH where Ngay='2023-10-01' and MaLopMH = 'LMH101' ";
